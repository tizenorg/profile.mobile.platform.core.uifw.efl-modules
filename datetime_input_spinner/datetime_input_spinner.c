   ...
   if (field_type == ELM_DATETIME_AMPM)
   ...
   else
     {
        ...
        if (field_type == ELM_DATETIME_HOUR)
          ...
          {
             elm_atspi_accessible_name_set(inc_button, dgettext("efl-modules", "IDS_COM_BODY_INCREASE_DAY"));
        ...
        else if (field_type == ELM_DATETIME_MONTH)
          {
             ...
             elm_atspi_accessible_name_set(dec_button, dgettext("efl-modules", "IDS_COM_BODY_DECREASE_MONTH"));
